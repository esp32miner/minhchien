...
def _delay(value):
	while not(value <= 1):
		value -= 0.123
		print(f'''\033[1;35m🚀 \033[1;35m[{lam}M-H\033[1;35m]\033[1;35m[{luc}TOOL-VIP\033[1;35m]\033[1;35m[{vang}DELAY\033[1;35m]\033[1;35m[{lam}{str(value)[0:5]}\033[1;35m]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''\033[1;35m🚀 \033[1;35m[{lam}M-H\033[1;35m]\033[1;35m[{luc}TOOL-VIP\033[1;35m]\033[1;35m[{vang}DELAY\033[1;35m]\033[1;35m[{lam}{str(value)[0:5]}\033[1;35m]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''\033[1;35m🚀 \033[1;35m[{lam}M-H\033[1;35m]\033[1;35m[{luc}TOOL-VIP\033[1;35m]\033[1;35m[{vang}DELAY\033[1;35m]\033[1;35m[{lam}{str(value)[0:5]}\033[1;35m]''', '               ', end = '\r')
...
def countdown(value):
	while not(value <= 1) :
		value -= 0.123
		print(f'''\033[1;35m🚀 \033[1;35m[{lam}M-H\033[1;35m]\033[1;35m[{luc}TOOL-VIP\033[1;35m]\033[1;35m[{vang}COUNTDOWN\033[1;35m]\033[1;35m[{lam}{str(value)[0:5]}\033[1;35m]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''\033[1;35m🚀 \033[1;35m[{lam}M-H\033[1;35m]\033[1;35m[{luc}TOOL-VIP\033[1;35m]\033[1;35m[{vang}COUNTDOWN\033[1;35m]\033[1;35m[{lam}{str(value)[0:5]}\033[1;35m]''', '               ', end = '\r')
		sleep(0.02)
		print(f'''\033[1;35m🚀 \033[1;35m[{lam}M-H\033[1;35m]\033[1;35m[{luc}TOOL-VIP\033[1;35m]\033[1;35m[{vang}COUNTDOWN\033[1;35m]\033[1;35m[{lam}{str(value)[0:5]}\033[1;35m]''', '               ', end = '\r')
...
def Main():
    ...
    print(f"{red}════════════════════════════════════════════════════")
    nhiemvu = input (f'\033[38;5;208m🚀 Nhập Nhiệm Vụ Cần Chạy: {lam}')
    min = int(input(f'\033[38;5;208m🚀 Nhập Delay Min: {lam}'))
    max = int(input(f'\033[38;5;208m🚀 Nhập Delay Max: {lam}'))
    nvblock = int(input(f'\033[38;5;208m🚀 Sau Bao Nhiêu Nhiệm Vụ Thì Chống Block: {lam}'))
    delaybl = int(input(f'\033[38;5;208m🚀 Sau {lam}{nvblock} \033[38;5;208mNhiệm Vụ Thì Nghỉ Ngơi: {lam}'))
    doinick = int(input(f'\033[38;5;208m🚀 Sau Bao Nhiêu Nhiệm Vụ Thì Đổi Nick: {lam}'))
    nhiemvuloi = int(input(f'\033[38;5;208m🚀 Lỗi Bao Nhiêu Nhiệm Vụ Thì Xóa Cookie: {lam}'))
    while True:
        if len(listck) == 0:
